        ...
        <div className='flex flex-col justify-between items-start gap-[25px]'>
          ...
          <div className='flex flex-col justify-between items-start gap-[30px]'>
            ...
            <div className='flex flex-col justify-between items-start gap-[30px]'>
              ...
              <button className='py-[10px] px-[18px] font-mons font-normal text-[24px] bg-[#140095] text-[#FFFFFF] border-[#140095] border-[2px] rounded-[6px] hover:bg-[#FFFFFF] hover:text-[#140095]' onClick={()=>addBin(data)}>Add to card</button>
              </div>
